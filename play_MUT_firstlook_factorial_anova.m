...
%                 'n_perm', n_perm, ...
%                 'save_GND', 'yes', ...
%                 'output_file', 'play_ModvsInst.xlsx');
% %Mod vs Equi bias
% GND = FclustGND(GND, 'bins', [10, 11], ...  
%                 'factor_names', 'bias', ...  
%                 'factor_levels', 2, ...
%                 'time_wind', time_wind, ...
%                 'chan_hood', chan_hood, ...
%                 'n_perm', n_perm, ...
%                 'save_GND', 'yes', ...
%                 'output_file', 'play_ModvsEqui.xlsx');
% %Inst vs Equi bias
% GND = FclustGND(GND, 'bins', [10, 12], ...  
%                 'factor_names', 'bias', ...  
%                 'factor_levels', 2, ...
%                 'time_wind', time_wind, ...
%                 'chan_hood', chan_hood, ...
%                 'n_perm', n_perm, ...
%                 'save_GND', 'yes', ...
%                 'output_file', 'play_InstvsEqui.xlsx');
